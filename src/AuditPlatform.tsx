...
export default function AuditPlatform({ onBack }: { onBack: () => void }) {
    ...
    <div className="min-h-screen bg-[#F2F2F2] text-[#333333] font-sans flex flex-col antialiased">
      ...
      <nav className="gov-navbar sticky top-0 z-[90] h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
           ...
           <button
             onClick={onBack}
             title="Volver al Análisis SECOP"
             className="px-3 py-2 text-[11px] font-bold uppercase flex items-center gap-1 border border-[#004884] text-[#004884] hover:bg-[#004884] hover:text-white transition-all"
           >
             ← Fase 1
           </button>
           <button
